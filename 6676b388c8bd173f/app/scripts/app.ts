...
angular
  .module('siteGeneratorStaticsMetadataAppInternal', ['siteGeneratorStaticsMetadataTranslations', 'siteGeneratorStaticsMetadataPreload', 'wixAngular']);
...
angular
  .module('siteGeneratorStaticsMetadataApp', ['siteGeneratorStaticsMetadataAppInternal'])
  .config(() => {
    return;
  });
